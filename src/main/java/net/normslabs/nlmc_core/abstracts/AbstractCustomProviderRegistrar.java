...
public abstract class AbstractCustomProviderRegistrar<
        TInternalProvider extends DataProvider>
        extends AbstractCustomProvider<TInternalProvider> {
    
    protected TInternalProvider internalProvider;
    protected final NlmcRegistrar modRegistrar;
    
    protected AbstractCustomProviderRegistrar(NlmcRegistrar modRegistrar) {
        super(modRegistrar);
