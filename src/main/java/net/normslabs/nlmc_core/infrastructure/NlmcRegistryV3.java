 ...
 *                   Example: Item for all NLMC item-types.
 * @param <TRegistrable> The type of the {@link IRegistrable} objects stored in this registry.
 * @author Marc-Eric Boury (TheNorm24) <webmaster@normslabs.net>
 * @since 2026-05-04 04:17
 */
public class NlmcRegistryV3<TMcObject, TRegistrable extends IRegistrable<? extends TMcObject>> {
    
    private final Map<ResourceLocation, TRegistrable> internalMap;
    
    public NlmcRegistryV3() {
        this.internalMap = new HashMap<>();
    }
    
    public NlmcRegistryV3(Map<ResourceLocation, TRegistrable> initialMap) {
        this();
