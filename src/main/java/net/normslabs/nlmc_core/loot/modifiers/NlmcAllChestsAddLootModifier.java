...
public class NlmcAllChestsAddLootModifier extends LootModifier implements INlmcLootModifier<NlmcAllChestsAddLootModifier> {
    
    public static final String CODEC_NAME = "nlmc_all_chests_add_loot_modifier";
    public static final Supplier<Codec<NlmcAllChestsAddLootModifier>> CODEC
            = Suppliers.memoize(() -> RecordCodecBuilder.create(inst -> codecStart(inst).and(
                    inst.group(
                        ...
                        .apply(inst, NlmcAllChestsAddLootModifier::new)));
     ...
     */
    protected NlmcAllChestsAddLootModifier(LootItemCondition[] conditionsIn, Item itemToAdd, int minItemCount, int maxItemCount, float chance) {
        super(conditionsIn);
     ...
     * @param conditionsIn the ILootConditions that need to be matched before the loot is modified.
     */
    protected NlmcAllChestsAddLootModifier(LootItemCondition[] conditionsIn, Item itemToAdd, int minItemCount, int maxItemCount) {
     ...
     * @param conditionsIn the ILootConditions that need to be matched before the loot is modified.
     */
    protected NlmcAllChestsAddLootModifier(LootItemCondition[] conditionsIn, Item itemToAdd, float chance) {
     ...
     * @param conditionsIn the ILootConditions that need to be matched before the loot is modified.
     */
    protected NlmcAllChestsAddLootModifier(LootItemCondition[] conditionsIn, Item itemToAdd) {
    ...
    public String getCodecName() {
        return NlmcAllChestsAddLootModifier.CODEC_NAME;
    }
    
    @Override
    public Supplier<Codec<NlmcAllChestsAddLootModifier>> getCodecSupplier() {
        return NlmcAllChestsAddLootModifier.CODEC;
    }
}
